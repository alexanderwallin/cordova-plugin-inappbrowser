...
- (void)createViews
{
    ...
    // Close button
    UIButton *closeButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 28, 28)];
    ...
    UIButton *forwButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 16, 28)];
    ...
    UIButton *backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 16, 28)];
