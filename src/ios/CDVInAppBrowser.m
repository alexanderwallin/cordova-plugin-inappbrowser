...
- (void)createViews
{
    ...
    // Close button
    UIButton *closeButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 24, 44)];
    ...
    [self.toolbar setItems:@[self.backButton, self.forwardButton, self.pageTitle, self.closeButton]];
